...
Crockpot features a powerful graph querying API, entirely type-safe thanks to [a fair bit of TypeScript](https://github.com/tobloef/crockpot/blob/main/src/query/run-query.types.ts).
