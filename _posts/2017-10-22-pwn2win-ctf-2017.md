...
category: "ctf"
redirect_from: 
 - "alias/pwn2win2017/header/top-secret"
 - "alias/pwn2win2017/header/regex-baby"
 - "alias/pwn2win2017/header/botnet-in-the-wild"
---
...
>
>[Link](/assets/pwn2win-ctf-2017/baby_regex.txt)
>
>
...
<script src="https://gist.github.com/tobloef/e0b89855d06a5ea6eba27ce281b8f771.js"></script>
...
I can do an explanation of each regex statement I used if there's interest, so let me know if that's something you want.
...
>
>[Message.txt](/assets/pwn2win-ctf-2017/Message.txt)
>
>[StrangeCircuit.jpg](/assets/pwn2win-ctf-2017/StrangeCircuit.jpg)
...
![Strange Circuit](/assets/pwn2win-ctf-2017/circuit_cropped.jpg)
...
![Shift register](/assets/pwn2win-ctf-2017/shift_register.jpg)
...
![Flip flops](/assets/pwn2win-ctf-2017/flip_flops.jpg)
...
The JK flip flops have two inputs, a clock and two outputs (only one of them is used here). When the clock pin, marked by a small triangle, goes to high the outputs changes according to this truth table:
...
<script src="https://gist.github.com/tobloef/2a7745f74c9ef5d0ad8c052d70797022.js"></script>
