...
The project was hosted on [AWS](https://aws.amazon.com/), with [GitHub Actions](https://github.com/features/actions) for CI/CD. On the frontend, the [Ant Design](https://ant.design/) UI library was used, and for the database we used [PostgreSQL](https://www.postgresql.org/) with the [Sequelize ORM](https://sequelize.org/). Testing is done with a mixture of [Jest](https://jestjs.io/) for unit test and integration tests and [Cypress](https://www.cypress.io/) for end-to-end tests.
