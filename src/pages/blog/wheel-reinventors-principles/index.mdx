---
title: "Wheel Reinventor's Principles"
subtitle: "Why and how I sometimes write stuff from scratch."
pubDate: 2024-07-09
...
<p className="de-emphasize">(While not strictly tied to the principles above, I have found the points below to help me foster a healthy mindset when doing wheel reinvention projects.)</p>

* Minimize third-party dependencies. Master the platform's built-ins and accumulate your own toolbox over time.
* Embrace the strengths of DIY. Create what _you_ need and little more. Be wary of abstractions made for fabricated use cases.
